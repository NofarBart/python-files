'''
This module contains functions to calculate the time spent by a tracked bodypart,
and was provieded by deeplabcut user Federico Claudi, all rights reserved.
Used it in analyze.py.
'''
import numpy as np
